...
namespace DiscordIntegration.Extensions.Extensions
{
    /// <summary>
                ...
                case UniversalDamageHandler universal:
                    {
                        ...
                        Log.Warning($"{nameof(DamageTypeExtensions)}.{nameof(damageHandlerBase)}: No matching {nameof(DamageType)} for {nameof(UniversalDamageHandler)} with ID {translation.Id}, type will be reported as {DamageType.Unknown}. Report this to EXILED Devs.");
